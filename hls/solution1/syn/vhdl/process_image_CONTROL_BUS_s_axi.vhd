...
entity process_image_CONTROL_BUS_s_axi is
generic (
...
end entity process_image_CONTROL_BUS_s_axi;
...
architecture behave of process_image_CONTROL_BUS_s_axi is
    ...
    constant ADDR_HEIGHT_DATA_0 : INTEGER := 16#14#;
    constant ADDR_HEIGHT_CTRL   : INTEGER := 16#18#;
    constant ADDR_WIDTH_DATA_0  : INTEGER := 16#1c#;
    constant ADDR_WIDTH_CTRL    : INTEGER := 16#20#;
