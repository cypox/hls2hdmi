...
#ifndef XPROCESS_IMAGE_H
#define XPROCESS_IMAGE_H
...
#ifndef __linux__
#define XProcess_image_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XProcess_image_ReadReg(BaseAddress, RegOffset) \
