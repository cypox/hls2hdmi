...
proc create_hier_cell_zynq_us_ss_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__DP_VIDEO_REF_CTRL__ACT_FREQMHZ {316.635000} \
   ...
   CONFIG.PSU__CRF_APB__VPLL_CTRL__FBDIV {76} \
   ...
   CONFIG.PSU__CRL_APB__AMS_REF_CTRL__ACT_FREQMHZ {51.718966} \
...
# Hierarchical cell: passthrough_0
proc create_hier_cell_passthrough_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_passthrough_0() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: process_image_0, and set properties
  set process_image_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:process_image:1.0 process_image_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_TPG_1 [get_bd_intf_pins S_AXI_TPG] [get_bd_intf_pins process_image_0/s_axi_CONTROL_BUS]
  connect_bd_intf_net -intf_net intf_net_bdry_in_S_AXI_GPIO [get_bd_intf_pins S_AXI_GPIO] [get_bd_intf_pins axi_gpio/S_AXI]
  connect_bd_intf_net -intf_net process_image_0_video_out [get_bd_intf_pins m_axis_video] [get_bd_intf_pins process_image_0/video_out]
  connect_bd_intf_net -intf_net s_axis_video_1 [get_bd_intf_pins s_axis_video] [get_bd_intf_pins process_image_0/video_in]

  # Create port connections
  connect_bd_net -net net_axi_gpio_gpio_io_o [get_bd_pins axi_gpio/gpio_io_o] [get_bd_pins process_image_0/ap_rst_n]
  connect_bd_net -net net_bdry_in_ap_clk [get_bd_pins ap_clk] [get_bd_pins axi_gpio/s_axi_aclk] [get_bd_pins process_image_0/ap_clk]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: passthrough_0
  create_hier_cell_passthrough_0 [current_bd_instance .] passthrough_0
  ...
  connect_bd_intf_net -intf_net intf_net_rx_video_axis_reg_slice_M_AXIS [get_bd_intf_pins passthrough_0/s_axis_video] [get_bd_intf_pins rx_video_axis_reg_slice/M_AXIS]
  ...
  connect_bd_intf_net -intf_net intf_net_v_tpg_ss_0_m_axis_video [get_bd_intf_pins passthrough_0/m_axis_video] [get_bd_intf_pins tx_video_axis_reg_slice/S_AXIS]
  ...
  connect_bd_intf_net -intf_net intf_net_zynq_us_ss_0_M05_AXI [get_bd_intf_pins passthrough_0/S_AXI_TPG] [get_bd_intf_pins zynq_us_ss_0/M05_AXI]
  ...
  connect_bd_intf_net -intf_net intf_net_zynq_us_ss_0_M08_AXI [get_bd_intf_pins passthrough_0/S_AXI_GPIO] [get_bd_intf_pins zynq_us_ss_0/M08_AXI]
  ...
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins passthrough_0/ap_clk] [get_bd_pins rx_video_axis_reg_slice/aclk] [get_bd_pins tx_video_axis_reg_slice/aclk] [get_bd_pins v_hdmi_rx_ss/s_axis_video_aclk] [get_bd_pins v_hdmi_tx_ss/s_axis_video_aclk] [get_bd_pins zynq_us_ss_0/clk_out2]
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked [get_bd_pins passthrough_0/m_axi_aresetn] [get_bd_pins rx_video_axis_reg_slice/aresetn] [get_bd_pins tx_video_axis_reg_slice/aresetn] [get_bd_pins v_hdmi_rx_ss/s_axis_video_aresetn] [get_bd_pins v_hdmi_tx_ss/s_axis_video_aresetn] [get_bd_pins zynq_us_ss_0/dcm_locked]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x80040000 [get_bd_addr_spaces zynq_us_ss_0/zynq_us/Data] [get_bd_addr_segs passthrough_0/axi_gpio/S_AXI/Reg] SEG_axi_gpio_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80050000 [get_bd_addr_spaces zynq_us_ss_0/zynq_us/Data] [get_bd_addr_segs passthrough_0/process_image_0/s_axi_CONTROL_BUS/Reg] SEG_process_image_0_Reg
